...
export const TasksApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    getActiveTasksTasksActiveTasksGet: async (
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      const localVarPath = `/tasks/active_tasks`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const TasksApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getActiveTasksTasksActiveTasksGet(
      options?: AxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TaskState>>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getActiveTasksTasksActiveTasksGet(
        options,
      );
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
...
export const TasksApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getActiveTasksTasksActiveTasksGet(options?: any): AxiosPromise<Array<TaskState>> {
      return localVarFp
        .getActiveTasksTasksActiveTasksGet(options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Available in socket.io
...
export class TasksApi extends BaseAPI {
   ...
   * @memberof TasksApi
   */
  public getActiveTasksTasksActiveTasksGet(options?: AxiosRequestConfig) {
