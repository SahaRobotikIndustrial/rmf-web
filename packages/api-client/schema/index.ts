  ...
  paths: {
    ...
    '/tasks/active_tasks': {
      get: {
        ...
        description: 'Returns all queued and underway tasks.',
        operationId: 'get_active_tasks_tasks_active_tasks_get',
        responses: {
          '200': {
            description: 'Successful Response',
            content: {
              'application/json': {
                schema: {
                  title: 'Response Get Active Tasks Tasks Active Tasks Get',
                  type: 'array',
                  items: { $ref: '#/components/schemas/TaskState' },
                },
              },
    ...
    schemas: {
      ...
      RobotState: {
        ...
        properties: {
          name: { title: 'Name', type: 'string' },
          status: {
            allOf: [{ $ref: '#/components/schemas/Status3' }],
            description: 'A simple token representing the status of the robot',
          },
          task_id: {
            title: 'Task Id',
